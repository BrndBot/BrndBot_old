...
public class ObjectFactory {
    ...
    private final static QName _ResourceID_QNAME = new QName("http://clients.mindbodyonline.com/api/0_5", "ID");
    ...
    public JAXBElement<Integer> createSessionTypeID(Integer value) {
        return new JAXBElement<Integer>(_ResourceID_QNAME, Integer.class, SessionType.class, value);
    }
    ...
    public JAXBElement<Integer> createLocationID(Integer value) {
        return new JAXBElement<Integer>(_ResourceID_QNAME, Integer.class, Location.class, value);
    }
