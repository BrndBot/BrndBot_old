...
@XmlSeeAlso({
    SendFinderUserNewPasswordResult.class,
    FinderCheckoutShoppingCartResult.class,
    GetBusinessLocationsWithinRadiusResult.class,
    AddOrUpdateFinderUsersResult.class,
    GetClassesWithinRadiusResult.class,
    GetFinderUserResult.class,
    GetSessionTypesWithinRadiusResult.class
})
