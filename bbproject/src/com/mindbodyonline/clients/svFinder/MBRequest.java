...
@XmlSeeAlso({
    GetClassesWithinRadiusRequest.class,
    GetSessionTypesWithinRadiusRequest.class,
    GetBusinessLocationsWithinRadiusRequest.class,
    AddOrUpdateFinderUsersRequest.class,
    FinderCheckoutShoppingCartRequest.class,
    SendFinderUserNewPasswordRequest.class,
    GetFinderUserRequest.class
})
